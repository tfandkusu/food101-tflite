...
def _conv_block(inputs, filters, alpha, kernel=(3, 3), strides=(1, 1)):
  ...
  x = Conv2D(
      ...
      strides=strides,
      name='conv1')(x)
  x = BatchNormalization(axis=channel_axis, name='conv1_bn', fused=True)(x)
...
def _depthwise_conv_block(inputs,
  ...
  x = BatchNormalization(axis=channel_axis, name='conv_dw_%d_bn' % block_id, fused=True)(x)
  ...
  x = Conv2D(
      ...
      name='conv_pw_%d' % block_id)(
          x)
  x = BatchNormalization(axis=channel_axis, name='conv_pw_%d_bn' % block_id, fused=True)(x)
